  ...
  const handleFormSubmit = async (data) => {
    ...
    try {
      if (showLogin) {
        ...
        // setting Token in cookies generated by firebase
         Cookies.set("firbase_token", userCredential.user.accessToken);
        console.log("user Login in successfully");
      
     
        console.log("user Login in successfully");

        // testing user credentials are generated by firebase or not
        console.log("firbaseUserCredentials", user);
      } else {
